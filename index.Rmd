...
Regression <- c("Generalized Linear Model (GLM)", "Linear Discriminant Analysis (LDA)")
Classification <- c("Classification and Regression Trees (CART)", "Support Vector Machines (SVM)", "K-Nearest Neighbors (KNN)", "Random Forest (RF)")
