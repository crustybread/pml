...
So in the GLM Model matrix, a value of 4506 in [A, A] indicates that in our training set of 19622 records, we predicted that 4506 records were A and we observed that 4506 were A. But if you look at [A, B], the value is 1074. This indicates that we predicted 1074 were B, when they should have been classified as A. That is, in order to have 100% accuracy, cell [A, A] should be the sum of 4506 and 1047, or 5580. So values on the diagonal of the matrix are where predictions match the observations. Any value in a row that is not on the diagonal is a prediction error. 

So on the first row, our out of bag error rate is 1074/4506+1074, or around 19.2%. Approximating the remaining rows:
2: 389/3408+389 = 10.2%
3: 138/3284+138 = 4.0%
4: 172/3004+172 = 5.4%
5: 95/3512+95 = 2.6%

The total of these errors is 41.4. The approximates the calcuated GLM accuracy of 40% from fit.glm$results.

It may seem odd that some columns are all zeroes in the GLM model. This is a case where the model failed to make any predictions for levels C, D, E of classe. Clearly, not a ggood fit. But you'll notice as the models move from left to right in the table above, our accuracy improves, along with our computation time, as the table below demonstrates. 
